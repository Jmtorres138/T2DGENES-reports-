...
file.vec <- sapply(tiss.vec,f1,y="_1_assoc.txt")
f2 <- function(dir,tissue){
          filename <- paste0(f1(dir,tissue),"_1_assoc.txt")
...
plot
write.table(count.df,"/Users/jtorres/Google Drive/Projects/PrediXcan/T2D-GENES/T2DGENES-reports-/Lasso.assoc.genes",
